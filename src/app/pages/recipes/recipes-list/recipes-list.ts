import { Component, ElementRef, HostListener, signal, viewChild, ViewChild, WritableSignal } from '@angular/core';
...
@Component({
  ...
  imports: [SearchField, MatIconModule, MatButtonModule, RecipeCard, MatProgressSpinnerModule, RouterLink, ReactiveFormsModule],
