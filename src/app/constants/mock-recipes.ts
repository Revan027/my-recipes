...
export const MOCK_STEPS: Step[] = [
  ...
  { id: 22, recipeID: 7, position: 1, title: 'Préparer la salade', content: 'Laver et essorer la laitue romaine, puis la couper en morceaux.' },
  { id: 23, recipeID: 7, position: 2, title: 'Cuire le poulet', content: 'Faire griller les escalopes de poulet, les assaisonner et les couper en lamelles.' },
  { id: 24, recipeID: 7, position: 3, title: 'Assembler', content: 'Mélanger la salade avec la sauce césar, ajouter les croûtons, le parmesan et le poulet.' },

  // Recette 8 - Pizza Margherita
  { id: 25, recipeID: 8, position: 1, title: 'Étaler la pâte', content: 'Étaler la pâte à pizza sur un plan de travail fariné jusqu’à obtenir un disque fin.' },
  { id: 26, recipeID: 8, position: 2, title: 'Garnir', content: 'Étaler la sauce tomate, répartir la mozzarella et quelques feuilles de basilic.' },
  { id: 27, recipeID: 8, position: 3, title: 'Cuire', content: 'Enfourner 12 minutes à 250°C jusqu’à ce que la pâte soit dorée et le fromage fondu.' },

  // Recette 9 - Soupe à l’oignon
  { id: 28, recipeID: 9, position: 1, title: 'Émincer les oignons', content: 'Émincer finement les oignons et les faire revenir doucement au beurre jusqu’à coloration.' },
  { id: 29, recipeID: 9, position: 2, title: 'Mouiller', content: 'Singer avec un peu de farine, verser le bouillon et laisser mijoter 20 minutes.' },
  { id: 30, recipeID: 9, position: 3, title: 'Gratiner', content: 'Verser dans des bols, ajouter des croûtons et du gruyère, puis gratiner au four.' },

  // Recette 10 - Tiramisu
  { id: 31, recipeID: 10, position: 1, title: 'Préparer la crème', content: 'Fouetter les jaunes d’œufs avec le sucre, puis incorporer le mascarpone.' },
  { id: 32, recipeID: 10, position: 2, title: 'Monter', content: 'Tremper les biscuits dans le café et alterner les couches de biscuits et de crème.' },
  { id: 33, recipeID: 10, position: 3, title: 'Réfrigérer', content: 'Saupoudrer de cacao et laisser reposer au frais au moins 4 heures avant de servir.' },

  // Recette 11 - Guacamole
  { id: 34, recipeID: 11, position: 1, title: 'Écraser les avocats', content: 'Écraser la chair des avocats à la fourchette dans un bol.' },
  { id: 35, recipeID: 11, position: 2, title: 'Assaisonner', content: 'Ajouter le jus de citron vert, la tomate, l’oignon, la coriandre, du sel et mélanger.' },

  // Recette 12 - Poulet rôti
  { id: 36, recipeID: 12, position: 1, title: 'Préparer le poulet', content: 'Badigeonner le poulet de beurre, saler, poivrer et glisser des herbes à l’intérieur.' },
  { id: 37, recipeID: 12, position: 2, title: 'Rôtir', content: 'Enfourner 1h15 à 200°C en arrosant régulièrement avec le jus de cuisson.' },
  { id: 38, recipeID: 12, position: 3, title: 'Reposer', content: 'Laisser reposer 10 minutes avant de découper et servir.' },

  // Recette 13 - Mojito
  { id: 39, recipeID: 13, position: 1, title: 'Piler', content: 'Piler la menthe avec le sucre et le jus de citron vert au fond du verre.' },
  { id: 40, recipeID: 13, position: 2, title: 'Compléter', content: 'Ajouter le rhum, des glaçons et compléter avec de l’eau gazeuse. Mélanger délicatement.' },
];
